...
public class HrController {
    ...
    public ResponseEntity<?> findAllHROrderByHighestRating(@AuthenticationPrincipal User user){
        return ResponseEntity.status(200).body(hrService.findAllHROrderByHighestRating(user.getId()));
    }
